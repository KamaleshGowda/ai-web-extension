...
from summarize.views import load_documents # Assuming load_documents is still used
...
def query_view(request):
    if request.method == 'POST':
        ...
        if not source or not user_query:
            return JsonResponse({"error": "Source and query are required."}, status=400)
